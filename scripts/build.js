...
const qbFiles = fs.readdirSync(qbDir).filter(f => f.endsWith(".json"));
const allQuestions = [];
...
console.log(`✓ Loaded ${allQuestions.length} questions across ${qbFiles.length} category files`);

// 2. Write src/questions.js
...
const WKQUIZ_QUESTIONS = ${JSON.stringify(allQuestions, null, 2)};
...
console.log("✓ Updated src/questions.js");
