...
// 3. Write lightweight src/questions.js (Index for instant count, questions loaded from Git on demand)
const questionsJsContent = `/**
 * WKQUIZ QUESTION BANK METADATA INDEX
 * Auto-generated by scripts/build.js
 * Total Questions in Git Repository: ${totalActiveQuestions}
 * Questions are fetched on-demand from Git keeping theme.xml ultra lightweight (<50 KB).
 */

const WKQUIZ_INDEX = ${JSON.stringify(indexJsonContent, null, 2)};
const WKQUIZ_QUESTIONS = []; // Questions fetched on-demand from Git
...
console.log("✓ Updated src/questions.js (Lightweight Git Index)");
